        ...
        <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <div class="py-16 flex justify-between items-center flex-col gap-8 lg:flex-row">
                ...
                <ul class="text-lg text-center sm:flex items-cente justify-center gap-14 lg:gap-10 xl:gap-14 transition-all duration-500">
                    <li ><a href="javascript:;"  class="text-white hover:text-[#F6D969]">Home</a></li>
                    <li ><a href="javascript:;"  class="text-white hover:text-[#F6D969]">About</a></li>
                    <li class="sm:my-0 my-2" ><a href="javascript:;"  class="text-white hover:text-[#F6D969]">Services</a></li>
                    <li ><a href="javascript:;"  class="text-white hover:text-[#F6D969]">Work</a></li>
                    <li  class="sm:my-0 my-2"><a href="javascript:;"  class="text-white hover:text-[#F6D969]">Contact</a></li>
                </ul>
                <div class="flex  space-x-4 sm:justify-center  ">
                    <a href="javascript:;"  class="w-9 h-9 rounded-full bg-[#2d123c] flex justify-center items-center hover:bg-[#F6D969]">
            ...
            <div class="py-7 border-t border-[#F6D969]">
                <div class="flex items-center justify-center">
                    <span class="text-[#F6D969]">©<a href="https://pagedone.io/">SalmaELHANI</a>2024, All rights reserved.</span>
                </div>
            </div>
        </div>
    </footer>
